      ...
      <div className="max-w-screen-xl flex flex-wrap md:flex-nowrap items-center justify-between mx-auto p-4 gap-4">
        ...
        <div className={`${open ? "block" : "hidden"} md:block order-3 md:order-2 w-full md:w-auto`}>
          <ul className="flex flex-col md:flex-row md:gap-8 p-4 md:p-0 items-start md:items-center">
            ...
            <li><Link className="text-heading" to="/devices">Devices</Link></li>
            <li><Link className="text-heading" to="/departments">Departments</Link></li>
            <li><Link className="text-heading" to="/maintenance">Maintenance</Link></li>
            <li><Link className="text-heading" to="/orders">Work Orders</Link></li>
            <li className="md:hidden"><Link to="register">Register</Link></li>
            <li className="md:hidden"><Link to="login">Login</Link></li>
            <li className="md:hidden"><span>SignOut</span></li>
          </ul>
        </div>
        ...
        <div className="flex items-center gap-3 order-2 md:order-3">
          ...
          <button className="flex items-center text-sm rounded-full">
            <img className="w-9 h-9 rounded-full object-cover" src={imgdefault} alt="user" />
          </button>
