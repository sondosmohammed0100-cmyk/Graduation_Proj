...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err.response?.data?.message || "Error in email or password. Please try again.";
      setError(msg);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center px-6 font-sans">
